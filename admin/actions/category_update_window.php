...
<!-- форма (модальное окно) для обновления -->
...
<div class="modal-body">
    <form id="form0" class="form-horizontal col-sm-12" >
        ...
        <div class="form-group"><label>Name</label>
            <input type="text" class="form-control required" placeholder="Category name" data-placement="top" data-trigger="manual" data-content="" name="category_name" value="<?php echo $rowItm['category_name']; ?>"></div>
        <div class="form-group"><label>Description</label>
            <textarea class="form-control" placeholder="Description" data-placement="top" data-trigger="manual" name="category_description"><?php echo $rowItm['category_description']; ?></textarea></div>
...
<script type="text/javascript">
    $("#upd").click(function () {
        $.post("actions/category_update.php", $("#form0").serialize())
                .done(function (data) {
